...
/*
TESTCASE("Copy Construct -Michael Gulson", "[weight=1][part=1]"){
  double coords[10][3] = {
    {5, 3, 1}, {3, 1, 10}, {2, 0, 8}, {4, 3, 0}, {0, 2, 9},
    {10, 10, 10}, {11, 11, 11}, {12, 12, 12}, {13, 13, 13}, {14, 14, 14}
  };
  ...
  KDTree<3> treecopy(tree);
  
  std::string fname = "test_result_kdtree_copy_1.kd";
  std::string fnamecopy = "testresultkdtree_copy_2.kd"
  writeKdTreeToFile(tree,fname);
  writeKdTreeToFile(tree,fnamecopy);
  compareBinaryFiles(fnamecopy, fname );
